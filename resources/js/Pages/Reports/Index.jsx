      ...
      <main className="page page-wide">
        ...
        <FilterBar onSubmit={(e) => e.preventDefault()}>
          ...
          <Field label="Niche">
            <Input
              ...
              onBlur={(e) =>
                applyFilters({ niche: e.target.value, viewFilter })
              }
            />
          </Field>
          <div className="filter-action">
            <Link href="/reports" className="micro">
              Reset
            </Link>
          </div>
        </FilterBar>
        ...
        {reports.length === 0 ? (
          <EmptyState
            ...
            sub="Generate reports from prospect detail pages."
          />
        ) : (
          <DataTable>
            <thead>
            ...
            <tbody>
              {reports.map((r) => (
                <tr
                  key={r.id}
                  onClick={() => router.visit(`/prospects/${r.prospect_id}`)}
                >
                  <td className="biz">
                    {r.business_name}
                    {r.is_engaged_badge && (
        ...
        {toast && (
          <Toast duration={1800} onClose={() => setToast(null)}>
            {toast}
          </Toast>
        )}
      </main>
