...
class ReportBuilderService
{
    ...
    public function cmsForProspect(Prospect $prospect): ?array
    {
        ...
        return [
            ...
            'label' => $this->cmsLabel($platform, $stored['version'] ?? null),
            'badge' => $this->cmsBadge($platform),
    ...
    private function cmsLabel(string $platform, mixed $version): string
    {
        $names = [
            'wordpress' => 'WordPress',
            'shopify' => 'Shopify',
    ...
    private function cmsBadge(string $platform): string
    {
