...
use App\Policies\ProspectListPolicy;
use App\Policies\ProspectPolicy;
use App\Policies\SearchPolicy;
use App\Policies\SharedListPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ProspectList::class, ProspectListPolicy::class);
        Gate::policy(SharedList::class, SharedListPolicy::class);
        Gate::policy(SharedSearch::class, SharedSearchPolicy::class);
