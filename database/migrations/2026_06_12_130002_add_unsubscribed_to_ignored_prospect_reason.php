...
{
    private const REASONS = ['acquired', 'cold', 'outreach_failed', 'unsubscribed', 'other'];
    ...
    {
        $driver = Schema::getConnection()->getDriverName();
        $legacyReasons = ['acquired', 'cold', 'outreach_failed', 'other'];
        ...
        if ($driver === 'mysql') {
            DB::table('ignored_prospects')->where('reason', 'unsubscribed')->delete();
